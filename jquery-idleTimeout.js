...
// version 1.0
// HEAVILY COMMENTED & LOGGED FOR DEBUGGING
...
(function($) {
  ...
  $.fn.idleTimeout = function(options) {
    ...
    return this.each(function() {
      ...
      // activity detector - restart idle timer if warning dialog is closed
      $('body').on(opts.activityEvents, function() {
          ...
          if (dialogOpen === true) {
            ...
            // all windows and tabs listen for storage event changes
